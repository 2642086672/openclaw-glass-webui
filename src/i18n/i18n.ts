...
const dict = {
  ...
  ttsSaved: { zh: 'TTS「{name}」已保存', en: 'TTS "{name}" saved' },
  ttsUpdated: { zh: 'TTS「{name}」已更新', en: 'TTS "{name}" updated' },
  // TTS 增强
  ttsEnabled: { zh: '启用语音', en: 'Enable TTS' },
  ttsOffline: { zh: '⚠ 网关未连接 — 修改将在连接后生效,当前显示的是上次保存的配置。', en: '⚠ Gateway offline — changes apply once connected. Showing last saved config.' },
  ttsActive: { zh: '当前激活', en: 'Active provider' },
  ttsAddNew: { zh: '新增提供商', en: 'Add provider' },
  ttsQuickTpl: { zh: '快速模板(点击填充):', en: 'Quick templates:' },
  ttsProviderName: { zh: '提供商名称', en: 'Provider name' },
  ttsApiKey: { zh: 'API Key', en: 'API Key' },
  ttsBaseUrl: { zh: 'API 地址', en: 'Base URL' },
  ttsModel: { zh: '模型', en: 'Model' },
  ttsVoice: { zh: '声音', en: 'Voice' },
  ttsRegion: { zh: '区域', en: 'Region' },
  ttsLang: { zh: '语言', en: 'Language' },
  ttsExtraJson: { zh: '额外参数(JSON)', en: 'Extra params (JSON)' },
  ttsEditing: { zh: '编辑「{name}」', en: 'Editing "{name}"' },
  ttsSaveEdit: { zh: '保存修改', en: 'Save changes' },
  ttsAddBtn: { zh: '添加提供商', en: 'Add provider' },
  ...
  debugQuick: { zh: '快速调用:', en: 'Quick call:' },
  debugResult: { zh: '返回结果:', en: 'Result:' },
  debugClear: { zh: '清空', en: 'Clear' },
  copy: { zh: '复制', en: 'Copy' },
